...
func (c *HTTPClient) Extract(ctx context.Context, staged models.StagedFile) (models.ParsedDocument, error) {
	if staged.Size > 300*1024*1024 {
		return models.ParsedDocument{}, fmt.Errorf("upload video less than 300 MB")
	}
	...
	if duration > maxVideoDuration {
		return models.ParsedDocument{}, fmt.Errorf("upload video less than 1 hour")
	}
...
func convertVideoToAudio(ctx context.Context, staged models.StagedFile) (string, int64, error) {
